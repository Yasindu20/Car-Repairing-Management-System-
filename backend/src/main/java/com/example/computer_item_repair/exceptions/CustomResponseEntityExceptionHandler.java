...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public final ResponseEntity<ProjectNotFoundExceptionResponse> handleProjectNotFoundException(
    ...
    @ExceptionHandler
    public final ResponseEntity<UsernameAlreadyExistsResponse> handleUsernameAlreadyExists(
